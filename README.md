...
```javascript
require('es-ext/array/from/implement');
...
```javascript
var aFrom = require('es-ext/array/from');
aFrom('foo'); // ['f', 'o', 'o']
```
...
```javascript
var aFrom = require('es-ext/array/from/shim');
aFrom('foo'); // ['f', 'o', 'o']
```
...
- `Array.from` -> `require('es-ext/array/from')`
- `Array.of` -> `require('es-ext/array/of')`
- `Array.prototype.concat` -> `require('es-ext/array/#/concat')`
- `Array.prototype.copyWithin` -> `require('es-ext/array/#/copy-within')`
- `Array.prototype.entries` -> `require('es-ext/array/#/entries')`
- `Array.prototype.fill` -> `require('es-ext/array/#/fill')`
- `Array.prototype.filter` -> `require('es-ext/array/#/filter')`
- `Array.prototype.find` -> `require('es-ext/array/#/find')`
- `Array.prototype.findIndex` -> `require('es-ext/array/#/find-index')`
- `Array.prototype.keys` -> `require('es-ext/array/#/keys')`
- `Array.prototype.map` -> `require('es-ext/array/#/map')`
- `Array.prototype.slice` -> `require('es-ext/array/#/slice')`
- `Array.prototype.splice` -> `require('es-ext/array/#/splice')`
- `Array.prototype.values` -> `require('es-ext/array/#/values')`
- `Array.prototype[@@iterator]` -> `require('es-ext/array/#/@@iterator')`
- `Math.acosh` -> `require('es-ext/math/acosh')`
- `Math.asinh` -> `require('es-ext/math/asinh')`
- `Math.atanh` -> `require('es-ext/math/atanh')`
- `Math.cbrt` -> `require('es-ext/math/cbrt')`
- `Math.clz32` -> `require('es-ext/math/clz32')`
- `Math.cosh` -> `require('es-ext/math/cosh')`
- `Math.exmp1` -> `require('es-ext/math/expm1')`
- `Math.fround` -> `require('es-ext/math/fround')`
- `Math.hypot` -> `require('es-ext/math/hypot')`
- `Math.imul` -> `require('es-ext/math/imul')`
- `Math.log1p` -> `require('es-ext/math/log1p')`
- `Math.log2` -> `require('es-ext/math/log2')`
- `Math.log10` -> `require('es-ext/math/log10')`
- `Math.sign` -> `require('es-ext/math/sign')`
- `Math.signh` -> `require('es-ext/math/signh')`
- `Math.tanh` -> `require('es-ext/math/tanh')`
- `Math.trunc` -> `require('es-ext/math/trunc')`
- `Number.EPSILON` -> `require('es-ext/number/epsilon')`
- `Number.MAX_SAFE_INTEGER` -> `require('es-ext/number/max-safe-integer')`
- `Number.MIN_SAFE_INTEGER` -> `require('es-ext/number/min-safe-integer')`
- `Number.isFinite` -> `require('es-ext/number/is-finite')`
- `Number.isInteger` -> `require('es-ext/number/is-integer')`
- `Number.isNaN` -> `require('es-ext/number/is-nan')`
- `Number.isSafeInteger` -> `require('es-ext/number/is-safe-integer')`
- `Object.assign` -> `require('es-ext/object/assign')`
- `Object.keys` -> `require('es-ext/object/keys')`
- `Object.setPrototypeOf` -> `require('es-ext/object/set-prototype-of')`
- `RegExp.prototype.match` -> `require('es-ext/reg-exp/#/match')`
- `RegExp.prototype.replace` -> `require('es-ext/reg-exp/#/replace')`
- `RegExp.prototype.search` -> `require('es-ext/reg-exp/#/search')`
- `RegExp.prototype.split` -> `require('es-ext/reg-exp/#/split')`
- `RegExp.prototype.sticky` -> Implement with `require('es-ext/reg-exp/#/sticky/implement')`, use as function with `require('es-ext/reg-exp/#/is-sticky')`
- `RegExp.prototype.unicode` -> Implement with `require('es-ext/reg-exp/#/unicode/implement')`, use as function with `require('es-ext/reg-exp/#/is-unicode')`
- `String.fromCodePoint` -> `require('es-ext/string/from-code-point')`
- `String.raw` -> `require('es-ext/string/raw')`
- `String.prototype.codePointAt` -> `require('es-ext/string/#/code-point-at')`
- `String.prototype.contains` -> `require('es-ext/string/#/contains')`
- `String.prototype.endsWith` -> `require('es-ext/string/#/ends-with')`
- `String.prototype.normalize` -> `require('es-ext/string/#/normalize')`
- `String.prototype.repeat` -> `require('es-ext/string/#/repeat')`
- `String.prototype.startsWith` -> `require('es-ext/string/#/starts-with')`
- `String.prototype[@@iterator]` -> `require('es-ext/string/#/@@iterator')`

#### Non ECMAScript standard features

__es-ext__ provides also other utils, and implements them as if they were proposed for a standard. It mostly offers methods (not functions) which can directly be assigned to native prototypes:

```javascript
Object.defineProperty(Function.prototype, 'partial', { value: require('es-ext/function/#/partial'),
  configurable: true, enumerable: false, writable: true });
Object.defineProperty(Array.prototype, 'flatten', { value: require('es-ext/array/#/flatten'),
  configurable: true, enumerable: false, writable: true });
Object.defineProperty(String.prototype, 'capitalize', { value: require('es-ext/string/#/capitalize'),
  configurable: true, enumerable: false, writable: true });
```

See [es-extend](https://github.com/wookieb/es-extend#es-extend), a great utility that automatically will extend natives for you. 
...
```javascript
var flatten = require('es-ext/array/#/flatten');
...
var flatten = call.bind(require('es-ext/array/#/flatten'));
...
```javascript
var util = {};
util.partial = call.bind(require('es-ext/function/#/partial'));
util.flatten = call.bind(require('es-ext/array/#/flatten'));
util.startsWith = call.bind(require('es-ext/string/#/starts-with'));
...
#### global _(es-ext/global)_

Object that represents global scope

### Array Constructor extensions

#### from(arrayLike[, mapFn[, thisArg]]) _(es-ext/array/from)_
...
#### arr.eLastIndexOf(searchElement[, fromIndex]) _(es-ext/array/#/e-last-index-of)_
...
#### arr.entries() _(es-ext/array/#/entries)_
...
#### arr.find(predicate[, thisArg]) _(es-ext/array/#/find)_
...
#### arr.findIndex(predicate[, thisArg]) _(es-ext/array/#/find-index)_
...
#### arr.last() _(es-ext/array/#/last)_

Returns value of last defined index

#### arr.lastIndex() _(es-ext/array/#/last)_

Returns last defined index of the array

#### arr.map(callback[, thisArg]) _(es-ext/array/#/map)_
...
#### arr.remove(value[, …valuen]) _(es-ext/array/#/remove)_

Remove values from the array

#### arr.separate(sep) _(es-ext/array/#/separate)_

Returns array with items separated with `sep` value

#### arr.slice(callback[, thisArg]) _(es-ext/array/#/slice)_
...
#### arr.someRight(cb[, thisArg]) _(es-ext/array/#/someRight)_

`some` starting from last element

#### arr.splice(callback[, thisArg]) _(es-ext/array/#/splice)_
...
#### arr.uniq() _(es-ext/array/#/uniq)_

Returns duplicate-free version of the array

#### arr.values() _(es-ext/array/#/values)_
...
#### arr[@@iterator] _(es-ext/array/#/@@iterator)_
...
#### isBoolean(x) _(es-ext/boolean/is-boolean)_

Whether value is boolean

### Date Constructor extensions

#### isDate(x) _(es-ext/date/is-date)_

Whether value is date instance

#### validDate(x) _(es-ext/date/valid-date)_

If given object is not date throw TypeError in other case return it.

### Date Prototype extensions

#### date.copy(date) _(es-ext/date/#/copy)_

Returns a copy of the date object

#### date.daysInMonth() _(es-ext/date/#/days-in-month)_

Returns number of days of date's month

#### date.floorDay() _(es-ext/date/#/floor-day)_

Sets the date time to 00:00:00.000

#### date.floorMonth() _(es-ext/date/#/floor-month)_

Sets date day to 1 and date time to 00:00:00.000

#### date.floorYear() _(es-ext/date/#/floor-year)_

Sets date month to 0, day to 1 and date time to 00:00:00.000

#### date.format(pattern) _(es-ext/date/#/format)_
...
#### constant(x) _(es-ext/function/constant)_

Returns a constant function that returns pregiven argument

_k(x)(y)  =def  x_

#### identity(x) _(es-ext/function/identity)_

Identity function. Returns first argument

_i(x)  =def  x_

#### invoke(name[, …args]) _(es-ext/function/invoke)_
...
#### isArguments(x) _(es-ext/function/is-arguments)_

Whether value is arguments object

#### isFunction(arg) _(es-ext/function/is-function)_

Wether value is instance of function

#### noop() _(es-ext/function/noop)_

No operation function

#### pluck(name) _(es-ext/function/pluck)_
...
#### validFunction(arg) _(es-ext/function/valid-function)_
...
#### fn.lock([…args]) _(es-ext/function/#/lock)_
...
#### isFinite(x) _(es-ext/number/is-finite)_
...
#### isInteger(x) _(es-ext/number/is-integer)_
...
#### isNaN(x) _(es-ext/number/is-nan)_
...
#### isNumber(x) _(es-ext/number/is-number)_

Whether given value is number

#### isSafeInteger(x) _(es-ext/number/is-safe-integer)_

[_Introduced with ECMAScript 6_](http://people.mozilla.org/~jorendorff/es6-draft.html#sec-number.issafeinteger).  

#### MAX_SAFE_INTEGER _(es-ext/number/max-safe-integer)_
...
#### num.pad(length[, precision]) _(es-ext/number/#/pad)_

Pad given number with zeros. Returns string

### Object Constructor extensions

#### assign(target, source[, …sourcen]) _(es-ext/object/assign)_
...
#### every(obj, cb[, thisArg[, compareFn]]) _(es-ext/object/every)_
...
#### getPropertyNames() _(es-ext/object/get-property-names)_

Get all (not just own) property names of the object

#### is(x, y) _(es-ext/object/is)_
...
#### map(obj, cb[, thisArg]) _(es-ext/object/map)_
...
#### mapKeys(obj, cb[, thisArg]) _(es-ext/object/map-keys)_

Create new object with same values, but remapped keys

#### mixin(target, source) _(es-ext/object/mixin)_
...
#### mixinPrototypes(target, …source]) _(es-ext/object/mixin-prototypes)_
...
#### normalizeOptions(options) _(es-ext/object/normalize-options)_
...
#### setPrototypeOf(object, proto) _(es-ext/object/set-prototype-of)_
...
#### some(obj, cb[, thisArg[, compareFn]]) _(es-ext/object/some)_

Analogous to Array.prototype.some Returns true if any key-value pair satisfies the provided
testing function.  
Optionally _compareFn_ can be provided which assures that keys are tested in given order. If provided _compareFn_ is equal to `true`, then order is alphabetical (by key).

#### toArray(obj[, cb[, thisArg[, compareFn]]]) _(es-ext/object/to-array)_
...
#### unserialize(str) _(es-ext/object/unserialize)_

Userializes value previously serialized with [serialize](#serializevalue-es-extobjectserialize)

#### validCallable(x) _(es-ext/object/valid-callable)_

If given object is not callable throw TypeError in other case return it.

#### validObject(x) _(es-ext/object/valid-object)_

Throws error if given value is not an object, otherwise it is returned.

#### validValue(x) _(es-ext/object/valid-value)_

Throws error if given value is `null` or `undefined`, otherwise returns value.

### RegExp Constructor extensions

#### escape(str) _(es-ext/reg-exp/escape)_

Escapes string to be used in regular expression

#### isRegExp(x) _(es-ext/reg-exp/is-reg-exp)_

Whether object is regular expression

#### validRegExp(x) _(es-ext/reg-exp/valid-reg-exp)_

If object is regular expression it is returned, otherwise TypeError is thrown.

### RegExp Prototype extensions

#### re.isSticky(x) _(es-ext/reg-exp/#/is-sticky)_
...
#### re.isUnicode(x) _(es-ext/reg-exp/#/is-unicode)_
...
#### re.unicode _(es-ext/reg-exp/#/unicode/implement)_
...
#### str.camelToHyphen() _(es-ext/string/#/camel-to-hyphen)_
...
#### str.capitalize() _(es-ext/string/#/capitalize)_

Capitalize first character of a string

#### str.caseInsensitiveCompare(str) _(es-ext/string/#/case-insensitive-compare)_

Case insensitive compare

#### str.codePointAt(pos) _(es-ext/string/#/code-point-at)_
...
#### str.indent(str[, count]) _(es-ext/string/#/indent)_

Indents each line with provided _str_ (if _count_ given then _str_ is repeated _count_ times).

#### str.last() _(es-ext/string/#/last)_

Return last character

#### str.normalize([form]) _(es-ext/string/#/normalize)_
...
#### str.plainReplace(search, replace) _(es-ext/string/#/plain-replace)_
...
#### str.plainReplaceAll(search, replace) _(es-ext/string/#/plain-replace-all)_
...
### Tests [![Build Status](https://travis-ci.org/medikoo/es-ext.png)](https://travis-ci.org/medikoo/es-ext)
