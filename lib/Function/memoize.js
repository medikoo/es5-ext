...
// in array is function or array of functions that would be run on given
// argument, value returned by function (or by last function if it's an array)
// is accepted as coerced value.
//
// memoizeFn = memoize(fn, 2, [String, Boolean]);
//
// Resolvers can be array of functions:
//
// memoizeFn = memoize(fn, 2, [[assertNotNull, String], Boolean]);
//
...
var isArray        = Array.isArray
  ...
  , indexOf        = require('../Array/prototype/index-of')
