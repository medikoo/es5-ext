...
// number of them.
//
// If we expect arguments of certain types it's good practice to pass resolvers,
// they would resolve arguments before they're parsed by memoizer (end function
// always receives arguments in they're initial form):
//
...
module.exports = function (fn, length, resolvers) {
	...
	mfn = function () {
		...
		return (found ? rset[index] :
			(rset[index] = apply.call(fn, this, arguments)));
	};
