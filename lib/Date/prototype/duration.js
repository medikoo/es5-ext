...
var call           = Function.prototype.call
  ...
  , bindMethods    = require('../../Object/plain/bind-methods').call
  , getPad         = require('../../Number/get-pad')
  , format         = require('../../String/format')

  , monthDaysCount = call.bind(require('./month-days-count'))
  , c              = call.bind(require('./copy'))
  , dfloor         = call.bind(require('./day-floor'))
  , mfloor         = call.bind(require('./month-floor'))
  , yfloor         = call.bind(require('./year-floor'))
